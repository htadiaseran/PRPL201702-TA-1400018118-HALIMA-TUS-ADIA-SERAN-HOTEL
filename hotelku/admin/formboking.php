...
<td>  Tanggal Booking :</td><td><input class="form-control" type="date" name="tglbok" placeholder="dd/mm/yyyy" 
required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"></td>
</tr><tr>
<td>  Tanggal Cek Out :</td><td><input class="form-control" type="date" name="tgl_kem" placeholder="dd/mm/yyyy" 
required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"></td>
</tr><tr>
